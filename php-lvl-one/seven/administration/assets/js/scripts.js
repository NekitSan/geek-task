...
document.querySelectorAll(".td__link--dell a").forEach(item => {
    item.addEventListener("click", () => {
        ...
        AREA__POPUP.innerHTML = `<div class="background">
            <div class="skip_wall">
                <div class="skip_wall__text">Вы действительно хотите удалить эту позицию?</div>
        ...
        document.querySelector('.skip_wall--Yes').addEventListener("click", () => {
            window.location.href = "admin-panel.php?page=admin-panel--dell&" + linkDell + "=" + idLink;
        });
    });
});